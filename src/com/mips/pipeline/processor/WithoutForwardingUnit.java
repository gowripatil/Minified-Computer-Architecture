...
public class WithoutForwardingUnit {
    ...
    public void generateTimingSequence(InstructionList instructionList) {
        ...
        for(int i=1; i<instructionList.getInstructionListLength(); i++) {
            ...
            if(dataHazardResponses.size() > 0) {
                if ((i - dataHazardResponses.get(0).previousInstructionNumber) == 1) {
                    numberOfStallsToInsert = 2;
                } else if ((i - dataHazardResponses.get(0).previousInstructionNumber) == 2) {
        ...
        System.out.println();
        System.out.println("Total Number of clock cycles(Forwarding Unit): " + clockCycles);
    }
